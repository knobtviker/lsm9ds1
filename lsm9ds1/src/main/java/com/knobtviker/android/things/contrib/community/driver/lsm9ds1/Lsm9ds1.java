package com.knobtviker.android.things.contrib.community.driver.lsm9ds1;
...
/**
 * Created by bojan on 10/01/2018.
 */
...
public class Lsm9ds1 implements Closeable {
    ...
    /**
     * Chip vendor for the LSM9DS1
     */
    public static final String CHIP_VENDOR = "STMicroelectronics";

    /**
     * Chip name for the LSM9DS1
     */
    public static final String CHIP_NAME = "LSM9DS1";
    ...
    @IntDef({AccelerometerRange.ACCEL_RANGE_2G, AccelerometerRange.ACCEL_RANGE_4G, AccelerometerRange.ACCEL_RANGE_8G, AccelerometerRange.ACCEL_RANGE_16G})
     ...
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({AccelerometerDecimation.ACCEL_DEC_0_SAMPLES, AccelerometerDecimation.ACCEL_DEC_2_SAMPLES, AccelerometerDecimation.ACCEL_DEC_4_SAMPLES, AccelerometerDecimation.ACCEL_DEC_8_SAMPLES})
     ...
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({GyroscopeScale.GYRO_SCALE_245DPS, GyroscopeScale.GYRO_SCALE_500DPS, GyroscopeScale.GYRO_SCALE_2000DPS})
     ...
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({AccelGyroOutputDataRate.ODR_POWER_DOWN, AccelGyroOutputDataRate.ODR_14_9HZ, AccelGyroOutputDataRate.ODR_59_5HZ, AccelGyroOutputDataRate.ODR_119HZ, AccelGyroOutputDataRate.ODR_238HZ, AccelGyroOutputDataRate.ODR_476HZ, AccelGyroOutputDataRate.ODR_952HZ})
     ...
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({MagnetometerGain.MAG_GAIN_4GAUSS, MagnetometerGain.MAG_GAIN_8GAUSS, MagnetometerGain.MAG_GAIN_12GAUSS, MagnetometerGain.MAG_GAIN_16GAUSS})
     ...
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({MagnetometerSystemOperatingMode.MAG_CONTINUOUS_CONVERSION, MagnetometerSystemOperatingMode.MAG_SINGLE_CONVERSION, MagnetometerSystemOperatingMode.MAG_POWER_DOWN})
     ...
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({MagnetometerXYOperatingMode.MAG_XY_OM_LOW_POWER, MagnetometerXYOperatingMode.MAG_XY_OM_MEDIUM_PERFORMANCE, MagnetometerXYOperatingMode.MAG_XY_OM_HIGH_PERFORMANCE, MagnetometerXYOperatingMode.MAG_XY_OM_ULTRA_HIGH_PERFORMANCE})
     ...
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({MagnetometerZOperatingMode.MAG_Z_OM_LOW_POWER, MagnetometerZOperatingMode.MAG_Z_OM_MEDIUM_PERFORMANCE, MagnetometerZOperatingMode.MAG_Z_OM_HIGH_PERFORMANCE, MagnetometerZOperatingMode.MAG_Z_OM_ULTRA_HIGH_PERFORMANCE})
     ...
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({MagOutputDataRate.ODR_M_0_625HZ, MagOutputDataRate.ODR_M_1_25HZ, MagOutputDataRate.ODR_M_2_5HZ, MagOutputDataRate.ODR_M_6HZ, MagOutputDataRate.ODR_M_10HZ, MagOutputDataRate.ODR_M_20HZ, MagOutputDataRate.ODR_M_40HZ, MagOutputDataRate.ODR_M_80HZ})
     ...
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({FifoMode.FIFO_OFF, FifoMode.FIFO_THS, FifoMode.FIFO_CONT_TRIGGER, FifoMode.FIFO_OFF_TRIGGER, FifoMode.FIFO_CONT})
    ...
    public @interface FifoThreshold {
    }

    @Retention(RetentionPolicy.SOURCE)
    @IntDef({SensorType.SENSOR_MAG, SensorType.SENSOR_XG})
    ...
    private void connect(@NonNull final Builder builder, @NonNull final I2cDevice accelGyroDevice, @NonNull final I2cDevice magDevice) throws IOException {
        ...
        resetAndReboot(SensorType.SENSOR_XG, false);
        resetAndReboot(SensorType.SENSOR_MAG, true);

        final byte idXg = readRegByte(SensorType.SENSOR_XG, REGISTER_WHO_AM_I_XG);
        final byte idMag = readRegByte(SensorType.SENSOR_MAG, REGISTER_WHO_AM_I_M);
    ...
    private byte getStatusRegister(@SensorType final int type) throws IOException {
        final int reg = type == SensorType.SENSOR_XG ? REGISTER_STATUS_REG : REGISTER_STATUS_REG_M;
    ...
    public boolean isTemperatureNewDataAvailable() throws IOException {
        return ((getStatusRegister(SensorType.SENSOR_XG) & 0xFF) & STATUS_REG_TDA) == STATUS_REG_TDA;
    }
    ...
    public boolean isAccelerometerNewDataAvailable() throws IOException {
        return ((getStatusRegister(SensorType.SENSOR_XG) & 0xFF) & STATUS_REG_XLDA) == STATUS_REG_XLDA;
    }
    ...
    public boolean isGyroscopeNewDataAvailable() throws IOException {
        return ((getStatusRegister(SensorType.SENSOR_XG) & 0xFF) & STATUS_REG_GDA) == STATUS_REG_GDA;
    }
    ...
    public boolean isMagnetometerXYZAxesNewDataAvailable() throws IOException {
        return ((getStatusRegister(SensorType.SENSOR_MAG) & 0xFF) & STATUS_REG_M_ZYXDA) == STATUS_REG_M_ZYXDA;
    }
    ...
    public boolean isMagnetometerXAxisNewDataAvailable() throws IOException {
        return ((getStatusRegister(SensorType.SENSOR_MAG) & 0xFF) & STATUS_REG_M_XDA) == STATUS_REG_M_XDA;
    }
    ...
    public boolean isMagnetometerYAxisNewDataAvailable() throws IOException {
        return ((getStatusRegister(SensorType.SENSOR_MAG) & 0xFF) & STATUS_REG_M_YDA) == STATUS_REG_M_YDA;
    }
    ...
    public boolean isMagnetometerZAxisNewDataAvailable() throws IOException {
        return ((getStatusRegister(SensorType.SENSOR_MAG) & 0xFF) & STATUS_REG_M_ZDA) == STATUS_REG_M_ZDA;
    }
    ...
    public int getAccelerometerRange() throws IOException {
        final byte reg = readRegByte(SensorType.SENSOR_XG, REGISTER_CTRL_REG6_XL);
    ...
    public void setAccelerometerRange(@AccelerometerRange final int range) throws IOException {
        ...
        byte reg = readRegByte(SensorType.SENSOR_XG, REGISTER_CTRL_REG6_XL);
        // Then mask out the accel range bits:
        reg &= ~(0b00011000);
        // Then mask in our new range bits:
        reg |= range;
        // And write the new register value back into CTRL_REG6_XL:
        writeRegByte(SensorType.SENSOR_XG, REGISTER_CTRL_REG6_XL, reg);

        switch (range) {
            case AccelerometerRange.ACCEL_RANGE_2G:
                mAccelMgLsb = ACCEL_MG_LSB_2G;
                break;
            case AccelerometerRange.ACCEL_RANGE_4G:
                mAccelMgLsb = ACCEL_MG_LSB_4G;
                break;
            case AccelerometerRange.ACCEL_RANGE_8G:
                mAccelMgLsb = ACCEL_MG_LSB_8G;
                break;
            case AccelerometerRange.ACCEL_RANGE_16G:
    ...
    public void setAccelerometerHighResolution(final boolean enable) throws IOException {
        ...
        byte reg = readRegByte(SensorType.SENSOR_XG, REGISTER_CTRL_REG7_XL);
        ...
        writeRegByte(SensorType.SENSOR_XG, REGISTER_CTRL_REG7_XL, reg);
    }
    ...
    public int getAccelerometerEnabledAxes() throws IOException {
        final byte reg = readRegByte(SensorType.SENSOR_XG, REGISTER_CTRL_REG5_XL);
    ...
    public void setAccelerometerEnabledAxes(final int axesFlag) throws IOException {
        ...
        byte reg = readRegByte(SensorType.SENSOR_XG, REGISTER_CTRL_REG5_XL);
        // Then mask out the gyro axes bits:
        reg &= ~(0b00111000);
        // Then mask in our new axes bits:
        reg |= axesFlag;
        // And write the new register value back into CTRL_REG5_XL:
        writeRegByte(SensorType.SENSOR_XG, REGISTER_CTRL_REG5_XL, reg);
    }
    ...
    public int getGyroscopeScale() throws IOException {
        final byte reg = readRegByte(SensorType.SENSOR_XG, REGISTER_CTRL_REG1_G);
        return (reg & 0b00011000) & 0xFF;
    }
    ...
    public void setGyroscopeScale(@GyroscopeScale final int scale) throws IOException {
        ...
        byte reg = readRegByte(SensorType.SENSOR_XG, REGISTER_CTRL_REG1_G);
        // Then mask out the gyro scale bits:
        reg &= ~(0b00011000);
        // Then mask in our new scale bits:
        reg |= scale;
        // And write the new register value back into CTRL_REG1_G:
        writeRegByte(SensorType.SENSOR_XG, REGISTER_CTRL_REG1_G, reg);

        switch (scale) {
            case GyroscopeScale.GYRO_SCALE_245DPS:
                mGyroDpsDigit = GYRO_DPS_DIGIT_245DPS;
                break;
            case GyroscopeScale.GYRO_SCALE_500DPS:
                mGyroDpsDigit = GYRO_DPS_DIGIT_500DPS;
                break;
            case GyroscopeScale.GYRO_SCALE_2000DPS:
    ...
    public int getGyroscopeAxesAngularRateNegativeSign() throws IOException {
        final byte reg = readRegByte(SensorType.SENSOR_XG, REGISTER_ORIENT_CFG_G);
        return (reg & 0b00111000) & 0xFF;
    }
    ...
    public void setGyroscopeAxesAngularRateNegativeSign(final int axesFlag) throws IOException {
        ...
        byte reg = readRegByte(SensorType.SENSOR_XG, REGISTER_ORIENT_CFG_G);
        // Then mask out the gyro axes bits:
        reg &= ~(0b00111000);
        // Then mask in our new axes bits:
        reg |= axesFlag;
        // And write the new register value back into ORIENT_CFG_G:
        writeRegByte(SensorType.SENSOR_XG, REGISTER_ORIENT_CFG_G, reg);
    }
    ...
    public int getMagnetometerGain() throws IOException {
        final byte reg = readRegByte(SensorType.SENSOR_MAG, REGISTER_CTRL_REG2_M);
    ...
    public void setMagnetometerGain(@MagnetometerGain final int gain) throws IOException {
        ...
        byte reg = readRegByte(SensorType.SENSOR_MAG, REGISTER_CTRL_REG2_M);
        // Then mask out the mag gain bits:
        reg &= ~(0b01100000);
        // Then mask in our new gain bits:
        reg |= gain;
        // And write the new register value back into CTRL_REG2_M:
        writeRegByte(SensorType.SENSOR_MAG, REGISTER_CTRL_REG2_M, reg);

        switch (gain) {
            case MagnetometerGain.MAG_GAIN_4GAUSS:
                mMagMgaussLsb = MAG_MGAUSS_4GAUSS;
                break;
            case MagnetometerGain.MAG_GAIN_8GAUSS:
                mMagMgaussLsb = MAG_MGAUSS_8GAUSS;
                break;
            case MagnetometerGain.MAG_GAIN_12GAUSS:
                mMagMgaussLsb = MAG_MGAUSS_12GAUSS;
                break;
            case MagnetometerGain.MAG_GAIN_16GAUSS:
    ...
    public int getMagnetometerSystemOperatingMode() throws IOException {
        final byte reg = readRegByte(SensorType.SENSOR_MAG, REGISTER_CTRL_REG3_M);
    ...
    public void setMagnetometerSystemOperatingMode(@MagnetometerSystemOperatingMode final int mode) throws IOException {
        ...
        byte reg = readRegByte(SensorType.SENSOR_MAG, REGISTER_CTRL_REG3_M);
        ...
        writeRegByte(SensorType.SENSOR_MAG, REGISTER_CTRL_REG3_M, reg);
    }
    ...
    public int getMagnetometerXYOperatingMode() throws IOException {
        final byte reg = readRegByte(SensorType.SENSOR_MAG, REGISTER_CTRL_REG1_M);
        return (reg & 0b01100000) & 0xFF;
    }
    ...
    public void setMagnetometerXYOperatingMode(@MagnetometerXYOperatingMode final int mode) throws IOException {
        ...
        byte reg = readRegByte(SensorType.SENSOR_MAG, REGISTER_CTRL_REG1_M);
        // Then mask out the mag operatingMode bits:
        reg &= ~(0b01100000);
        // Then mask in our new operatingMode bits:
        reg |= mode;
        // And write the new register value back into CTRL_REG1_M:
        writeRegByte(SensorType.SENSOR_MAG, REGISTER_CTRL_REG1_M, reg);
    }
    ...
    public int getMagnetometerZOperatingMode() throws IOException {
        final byte reg = readRegByte(SensorType.SENSOR_MAG, REGISTER_CTRL_REG4_M);
    ...
    public void setMagnetometerZOperatingMode(@MagnetometerZOperatingMode final int mode) throws IOException {
        ...
        byte reg = readRegByte(SensorType.SENSOR_MAG, REGISTER_CTRL_REG4_M);
        // Then mask out the mag operatingMode bits:
        reg &= ~(0b00001100);
        // Then mask in our new operatingMode bits:
        reg |= mode;
        // And write the new register value back into CTRL_REG4_M:
        writeRegByte(SensorType.SENSOR_MAG, REGISTER_CTRL_REG4_M, reg);
    }
    ...
    public int[] readRawAccelerometerData() throws IOException {
        ...
        readRegBuffer(SensorType.SENSOR_XG, REGISTER_OUT_X_L_XL, buffer, buffer.length);
    ...
    public int[] readRawMagnetometerData() throws IOException {
        ...
        readRegBuffer(SensorType.SENSOR_MAG, REGISTER_OUT_X_L_M, buffer, buffer.length);
    ...
    public int[] getRawGyroscopeData() throws IOException {
        ...
        readRegBuffer(SensorType.SENSOR_XG, REGISTER_OUT_X_L_G, buffer, buffer.length);
        result[0] = (((int) buffer[1]) << 8) | (buffer[0] & 0xFF); // Store x-axis values
        result[1] = (((int) buffer[3]) << 8) | (buffer[2] & 0xFF); // Store y-axis values
        result[2] = (((int) buffer[5]) << 8) | (buffer[4] & 0xFF); // Store z-axis values
    ...
    public int readRawTemperature() throws IOException {
        ...
        readRegBuffer(SensorType.SENSOR_XG, REGISTER_TEMP_OUT_L, buffer, buffer.length);
    ...
    public void setSleepGyroscopeEnabled(final boolean enable) throws IOException {
        byte temp = readRegByte(SensorType.SENSOR_XG, REGISTER_CTRL_REG9);
        ...
        writeRegByte(SensorType.SENSOR_XG, REGISTER_CTRL_REG9, temp);
    }
    ...
    public void setFifoModeAndTreshold(@FifoMode final int mode, @FifoThreshold int threshold) throws IOException {
        ...
        writeRegByte(SensorType.SENSOR_XG, REGISTER_FIFO_CTRL, (byte) (mode | (threshold & 0b0011111)));
    }
    ...
    public int getFifoSamplesCount() throws IOException {
        return readRegByte(SensorType.SENSOR_XG, REGISTER_FIFO_SRC) & 0b00111111;
    }
    ...
    private byte readRegByte(@SensorType final int sensorType, final int reg) throws IOException {
        if (sensorType == SensorType.SENSOR_MAG) {
            if (mMagDevice == null) {
    ...
    public static class Builder {
        ...
        private int mAccelerometerOdr = AccelGyroOutputDataRate.ODR_952HZ;
        private int mAccelerometerEnabledAxes = ACCEL_AXIS_Z | ACCEL_AXIS_Y | ACCEL_AXIS_X;
        @AccelerometerDecimation
        private int mAccelerometerDecimation = AccelerometerDecimation.ACCEL_DEC_0_SAMPLES;
        private boolean mAccelerometerHighResolution = true;
        @AccelerometerRange
        private int mAccelerometerRange = AccelerometerRange.ACCEL_RANGE_2G;

        // Gyroscope configuration
        @AccelGyroOutputDataRate
        private int mGyroscopeOdr = AccelGyroOutputDataRate.ODR_952HZ;
        @GyroscopeScale
        private int mGyroscopeScale = GyroscopeScale.GYRO_SCALE_245DPS;

        // Magnetometer configuration
        private boolean mMagnetometerTemperatureCompensation = false;
        @MagnetometerXYOperatingMode
        private int mMagnetometerXYOperatingMode = MagnetometerXYOperatingMode.MAG_XY_OM_LOW_POWER;
        @MagnetometerZOperatingMode
        private int mMagnetometerZOperatingMode = MagnetometerZOperatingMode.MAG_Z_OM_LOW_POWER;
        @MagnetometerSystemOperatingMode
        private int mMagnetometerSystemOperatingMode = MagnetometerSystemOperatingMode.MAG_CONTINUOUS_CONVERSION;
        @MagnetometerGain
        private int mMagnetometerGain = MagnetometerGain.MAG_GAIN_4GAUSS;
