...
import static com.knobtviker.android.things.contrib.community.driver.lsm9ds1.Lsm9ds1.AccelGyroOutputDataRate.ODR_952HZ;
import static com.knobtviker.android.things.contrib.community.driver.lsm9ds1.Lsm9ds1.AccelGyroOutputDataRate.ODR_POWER_DOWN;
import static com.knobtviker.android.things.contrib.community.driver.lsm9ds1.Lsm9ds1.MagnetometerSystemOperatingMode.MAG_CONTINUOUS_CONVERSION;
import static com.knobtviker.android.things.contrib.community.driver.lsm9ds1.Lsm9ds1.MagnetometerSystemOperatingMode.MAG_POWER_DOWN;
...
public class Lsm9ds1SensorDriver implements AutoCloseable {
    ...
    private static final String DRIVER_VENDOR = Lsm9ds1.CHIP_VENDOR;
    private static final String DRIVER_NAME = Lsm9ds1.CHIP_NAME;
     ...
     * The driver emits {@link Sensor} with acceleration, angular velocity,
